...
export default function ProductList() {
  ...
  // creacting useEffect to reset the page for pagination 1
  useEffect(() => {
    setPage(1);
  }, [totalItems, sort]);
        ...
        <div className="bg-white">
          <div>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              {/* ssection of product and filter ends  */}
              {/* pagination  */}
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8  ">
            {products.map((product) => (
              <Link to={`/product-detail/${product.id}`} key={product.id}>
                <div
                  key={product.id}
                  className="group relative p-0.5  rounded-lg shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]"
                >
                  ...
                  <div className="mt-2 flex justify-between mb-2 p-2 ">
                    <div>
                      ...
                      <p className="mt-1 flex text-sm text-gray-500">
                        <StarIcon className="w-3 h-3 inline mt-1" />,
